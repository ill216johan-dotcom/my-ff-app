...
export default function ArbitrationList({ orders, onSelect }) {
              ...
              <CardContent className="p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <Button className="bg-orange-500 hover:bg-orange-600 text-white dark:text-white" onClick={() => onSelect(order)}>
                      Подключиться
                    </Button>
