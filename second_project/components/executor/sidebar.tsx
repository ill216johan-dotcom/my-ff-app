...
import type { ExecutorView } from "@/app/executor/page"
import { Avatar, AvatarFallback } from "@/components/ui/avatar"

interface ExecutorSidebarProps {
  currentView: ExecutorView
  onNavigate: (view: ExecutorView) => void
}

const notifications = {
  newOrders: 5, // новые заказы на бирже
  messages: 2, // непрочитанные сообщения от клиентов
  myOrders: 1, // обновления по своим заказам
}

export function ExecutorSidebar({ currentView, onNavigate }: ExecutorSidebarProps) {
